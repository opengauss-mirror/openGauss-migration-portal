...
import org.opengauss.migration.constants.config.DataCheckerCheckConfig;
import org.opengauss.migration.constants.config.DataCheckerSinkConfig;
import org.opengauss.migration.constants.config.DataCheckerSourceConfig;
...
import org.opengauss.migration.enums.DataCheckerProcessType;
...
import org.opengauss.migration.utils.PortUtils;
...
public abstract class DataCheckerTask extends ToolTask {
     ...
     */
    protected final MysqlMigrationConfig migrationConfigDto;
    ...
    protected DataCheckerTask(
            ...
            MysqlMigrationConfig migrationConfigDto, DataCheckerConfigBundle dataCheckerConfig) {
        super(taskWorkspace);
