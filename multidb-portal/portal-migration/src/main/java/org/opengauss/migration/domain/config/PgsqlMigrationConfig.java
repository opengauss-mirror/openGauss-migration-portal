 ...
 */
@Getter
public class PgsqlMigrationConfig extends AbstractMigrationConfig {
    /**
     ...
     */
    public static PgsqlMigrationConfig generatePgsqlMigrationConfigDto(Map<String, Object> configMap) {
        if (configMap == null) {
            throw new IllegalArgumentException(
                    "Config map that is used to generate PostgreSQL migration config dto cannot be null");
        }
        PgsqlMigrationConfig dto = new PgsqlMigrationConfig();
    ...
    private static void readDatabasePassword(PgsqlMigrationConfig dto, Map<String, Object> configMap) {
