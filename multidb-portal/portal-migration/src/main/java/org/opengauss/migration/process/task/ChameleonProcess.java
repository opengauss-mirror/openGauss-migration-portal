...
import org.opengauss.migration.constants.config.ChameleonConfig;
...
public class ChameleonProcess extends TaskProcess {
    ...
    private Map<String, String> generateChameleonProcessEnv() {
        ...
        MysqlMigrationConfig mysqlMigrationConfigDto = mysqlMigrationJobConfig.getMigrationConfigDto();
