...
import org.opengauss.migration.constants.config.FullReplicateConfig;
...
public class FullReplicatePgsqlMigrationConfigHelper {
     ...
     */
    public static Map<String, Object> pgsqlFullMigrationConfig(PgsqlMigrationConfig dto, TaskWorkspace workspace) {
     ...
     * @return change params
     */
    public static Map<String, Object> pgsqlFullMigrationRecordSnapshotConfig(PgsqlMigrationConfig dto) {
        HashMap<String, Object> changeParams = new HashMap<>();
     ...
     */
    public static int getMajorPgsqlVersion(PgsqlMigrationConfig dto) {
     ...
     */
    public static Map<String, String> getMigrationSchemaMappings(PgsqlMigrationConfig dto) {
