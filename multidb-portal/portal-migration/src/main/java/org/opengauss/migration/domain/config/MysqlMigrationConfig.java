...
import org.opengauss.migration.domain.model.DatabaseConnectInfo;
 ...
 */
@Getter
public class MysqlMigrationConfig extends AbstractMigrationConfig {
    /**
     ...
     */
    public static MysqlMigrationConfig generateMysqlMigrationConfigDto(Map<String, Object> configMap) {
        if (configMap == null) {
            throw new IllegalArgumentException(
                    "Config map that is used to generate MySQL migration config dto cannot be null");
        }
        MysqlMigrationConfig dto = new MysqlMigrationConfig();
    ...
    private static void readDatabasePassword(MysqlMigrationConfig dto, Map<String, Object> configMap) {
