...
import org.opengauss.migration.constants.config.DataCheckerConfig;
...
import org.opengauss.migration.job.config.AbstractMigrationJobConfig;
import org.opengauss.migration.job.config.MysqlMigrationJobConfig;
import org.opengauss.migration.helper.tool.DataCheckerHelper;
import org.opengauss.utils.FileUtils;
import org.opengauss.migration.utils.ProcessUtils;
...
public class DataCheckerProcess extends TaskProcess {
    ...
    private Map<String, String> generateDataCheckProcessEnv() {
        ...
        MysqlMigrationConfig migrationConfigDto = mysqlMigrationJobConfig.getMigrationConfigDto();
