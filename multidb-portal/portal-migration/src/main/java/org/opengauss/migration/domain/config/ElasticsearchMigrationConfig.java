...
package org.opengauss.migration.domain.config;

import lombok.Getter;
import org.elasticsearch.client.RestClient;
import org.opengauss.migration.constants.ConfigValidationConstants;
import org.opengauss.migration.constants.config.MigrationConfig;
import org.opengauss.migration.domain.model.ElasticsearchConnectInfo;
import org.opengauss.migration.domain.model.OpenGaussDatabaseConnectInfo;
import org.opengauss.migration.exceptions.ConfigException;
import org.opengauss.migration.utils.ConsoleReader;
import org.opengauss.migration.utils.ElasticsearchUtils;
 ...
 */
@Getter
public class ElasticsearchMigrationConfig extends AbstractMigrationConfig {
    /**
     ...
     */
    public static ElasticsearchMigrationConfig generateElasticsearchMigrationConfigDto(
            Map<String, Object> configMap) {
        if (configMap == null) {
            throw new IllegalArgumentException(
                    "Config map that is used to generate Elasticsearch migration config dto cannot be null");
        }
        ElasticsearchMigrationConfig dto = new ElasticsearchMigrationConfig();
    ...
    private static void readDatabasePassword(ElasticsearchMigrationConfig dto, Map<String, Object> configMap) {
