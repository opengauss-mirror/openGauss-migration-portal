...
import org.opengauss.migration.domain.config.AbstractMigrationConfig;
...
public abstract class AbstractMigrationJob {
     ...
     */
    protected void adjustKernelFsyncParam(boolean isOn, AbstractMigrationConfig migrationConfigDto)
            throws SQLException {
