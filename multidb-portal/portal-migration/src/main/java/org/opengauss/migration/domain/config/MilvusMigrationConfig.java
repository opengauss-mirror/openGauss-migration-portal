...
import org.opengauss.migration.utils.MilvusUtils;
 ...
 */
@Getter
public class MilvusMigrationConfig extends AbstractMigrationConfig {
    /**
     ...
     */
    public static MilvusMigrationConfig generateMilvusMigrationConfigDto(Map<String, Object> configMap) {
        if (configMap == null) {
            throw new IllegalArgumentException(
                    "Config map that is used to generate Milvus migration config dto cannot be null");
        }
        MilvusMigrationConfig dto = new MilvusMigrationConfig();
    ...
    private static void readDatabasePassword(MilvusMigrationConfig dto, Map<String, Object> configMap) {
