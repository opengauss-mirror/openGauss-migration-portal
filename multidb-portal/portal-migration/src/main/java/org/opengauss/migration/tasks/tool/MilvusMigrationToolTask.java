...
import org.opengauss.migration.constants.config.MilvusMigrationToolConfig;
...
public abstract class MilvusMigrationToolTask extends ToolTask {
    ...
    protected MilvusMigrationToolTask(
            TaskWorkspace taskWorkspace, MilvusMigrationConfig migrationConfigDto, ConfigFile configFile,
    ...
    private Map<String, String> generateProcessEnv(MilvusMigrationConfig migrationConfigDto) {
