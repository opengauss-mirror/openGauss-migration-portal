...
import org.opengauss.migration.constants.config.ElasticsearchMigrationToolConfig;
...
public abstract class ElasticsearchMigrationToolTask extends ToolTask {
    ...
    protected ElasticsearchMigrationToolTask(
            TaskWorkspace taskWorkspace, ElasticsearchMigrationConfig migrationConfigDto, ConfigFile configFile,
    ...
    private Map<String, String> generateProcessEnv(ElasticsearchMigrationConfig migrationConfigDto) {
